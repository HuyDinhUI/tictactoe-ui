...
const ModePage = () => {
  ...
  const board = ["X", "O", null, null, "X", "O", "O", null, "X"];
          ...
          <div class="edit_mode">
            <div class="container_edit--mode">
              ...
              <div class="options_level">
                <button
                  onClick={() => selected_level("easy")}
                  class="easy difficulty"
                >
                  easy
                </button>
                <button
                  onClick={() => selected_level("medium")}
                  class="medium difficulty unselect"
                >
                  medium
                </button>
                <button
                  onClick={() => selected_level("hard")}
                  class="hard difficulty unselect"
                >
                  hard
                </button>
                <button
                  onClick={() => selected_level("extreme")}
                  class="extreme difficulty unselect"
                >
                  extreme
                </button>
              </div>
              ...
              <div class="size_board">
                <button onClick={() => selected_size(9)} class="size available">
                  3<br></br>x<br></br>3
                </button>
                <button
                  onClick={() => selected_size(16)}
                  class="size available"
                >
                  4<br></br>x<br></br>4
                </button>
                <button
                  onClick={() => selected_size(25)}
                  class="size available"
                >
                  5<br></br>x<br></br>5
                </button>
                <button
                  onClick={() => selected_size(49)}
                  class="size available"
                >
                  7<br></br>x<br></br>7
                </button>
                <button
                  onClick={() => selected_size(81)}
                  class="size available"
                >
                  9<br></br>x<br></br>9
                </button>
                <button
                  onClick={() => selected_size(225)}
                  disabled={
                    difficulty === "hard" ||
                    difficulty === "medium" ||
                    difficulty === "easy"
              ...
              <button
                onClick={PlayGame_Bot}
                disabled={size == null}
                class="bt_start_game"
              >
                start
              </button>
              <button onClick={display_bot} class="close">
                x
              </button>
            </div>
          </div>
        ...
        {mode_human && (
          <div class="edit_mode">
            <div class="container_edit--mode">
              ...
              <button
                onClick={PlayGame_Human}
                disabled={size == null}
                class="bt_start_game"
              >
                start
              </button>
              <button onClick={display_human} class="close">
                x
              </button>
            </div>
          </div>
        ...
        {mode_chal && (
          <div class="edit_mode">
            <div class="container_edit--mode">
              ...
              <button
                onClick={PlayGame_Chal}
                disabled={size == null && time == null}
                class="bt_start_game"
              >
                start
              </button>
              <button onClick={display_chal} class="close">
                x
              </button>
            </div>
          </div>
